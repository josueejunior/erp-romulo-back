...
class ProcessoCreateRequest extends FormRequest
{
    ...
    {
        return [
            'orgao_id.required' => 'Selecione um órgão.',
            ...
            'numero_modalidade.required' => 'Informe o número/ano.',
            ...
            'data_hora_sessao_publica.required' => 'Informe a data e hora da sessão pública.',
