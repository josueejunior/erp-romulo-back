...
class CriarProcessoDTO
{
    ...
    public static function fromArray(array $data): self
    {
        return new self(
            ...
            dataHoraSessaoPublica: isset($data['data_hora_sessao_publica']) ? Carbon::parse($data['data_hora_sessao_publica']) : null,
            horarioSessaoPublica: isset($data['horario_sessao_publica']) ? Carbon::parse($data['horario_sessao_publica']) : null,
            ...
            validadePropostaInicio: isset($data['validade_proposta_inicio']) ? Carbon::parse($data['validade_proposta_inicio']) : null,
            validadePropostaFim: isset($data['validade_proposta_fim']) ? Carbon::parse($data['validade_proposta_fim']) : null,
            ...
            dataRecebimentoPagamento: isset($data['data_recebimento_pagamento']) ? Carbon::parse($data['data_recebimento_pagamento']) : null,
