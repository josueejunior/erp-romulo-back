...
final class CadastrarEmpresaPublicamenteUseCase
{
    ...
    private function criarTenantEUsuario(CadastroPublicoDTO $dto): array
    {
        ...
        $tenantDTO = CriarTenantDTO::fromArray([
            ...
            'email_licitacao' => $dto->emailLicitacao,
            'endereco' => $dto->endereco,
            'cidade' => $dto->cidade,
            'estado' => $dto->estado,
            'cep' => $dto->cep,
            'telefones' => $dto->telefones,
            'telefone_fixo' => $dto->telefoneFixo,
            'site' => $dto->site,
            'inscricao_estadual' => $dto->inscricaoEstadual,
            'inscricao_municipal' => $dto->inscricaoMunicipal,
            'cnae_principal' => $dto->cnaePrincipal,
            'data_abertura' => $dto->dataAbertura,
            'favorecido_razao_social' => $dto->favorecidoRazaoSocial,
            'favorecido_cnpj' => $dto->favorecidoCnpj,
            'representante_legal_nome' => $dto->representanteLegalNome,
            'representante_legal_cpf' => $dto->representanteLegalCpf,
            'representante_legal_rg' => $dto->representanteLegalRg,
            'representante_legal_telefone' => $dto->representanteLegalTelefone,
            'representante_legal_email' => $dto->representanteLegalEmail,
            'representante_legal_cargo' => $dto->representanteLegalCargo,
            'responsavel_comercial' => $dto->responsavelComercial,
            'responsavel_financeiro' => $dto->responsavelFinanceiro,
            'responsavel_licitacoes' => $dto->responsavelLicitacoes,
            'ramo_atuacao' => $dto->ramoAtuacao,
            'principais_produtos_servicos' => $dto->principaisProdutosServicos,
            'marcas_trabalhadas' => $dto->marcasTrabalhadas,
