...
class TenantRepository implements TenantRepositoryInterface
{
    ...
    private function toDomain(TenantModel $model): Tenant
    {
        return new Tenant(
            ...
            logo: $model->logo,
            telefoneFixo: $model->telefone_fixo,
            emailFinanceiro: $model->email_financeiro,
            emailLicitacao: $model->email_licitacao,
            inscricaoEstadual: $model->inscricao_estadual,
            inscricaoMunicipal: $model->inscricao_municipal,
            cnaePrincipal: $model->cnae_principal,
            dataAbertura: $model->data_abertura,
            representanteLegalRg: $model->representante_legal_rg,
            representanteLegalTelefone: $model->representante_legal_telefone,
            representanteLegalEmail: $model->representante_legal_email,
            favorecidoRazaoSocial: $model->favorecido_razao_social,
            favorecidoCnpj: $model->favorecido_cnpj,
            responsavelComercial: $model->responsavel_comercial,
            responsavelFinanceiro: $model->responsavel_financeiro,
            responsavelLicitacoes: $model->responsavel_licitacoes,
            ramoAtuacao: $model->ramo_atuacao,
            principaisProdutosServicos: $model->principais_produtos_servicos,
            marcasTrabalhadas: $model->marcas_trabalhadas,
    ...
    private function toArray(Tenant $tenant): array
    {
        return [
            ...
            'telefone_fixo' => $tenant->telefoneFixo,
            'email_financeiro' => $tenant->emailFinanceiro,
            'email_licitacao' => $tenant->emailLicitacao,
            'banco' => $tenant->banco,
            ...
            'representante_legal_rg' => $tenant->representanteLegalRg,
            'representante_legal_telefone' => $tenant->representanteLegalTelefone,
            'representante_legal_email' => $tenant->representanteLegalEmail,
            'favorecido_razao_social' => $tenant->favorecidoRazaoSocial,
            'favorecido_cnpj' => $tenant->favorecidoCnpj,
            'inscricao_estadual' => $tenant->inscricaoEstadual,
            'inscricao_municipal' => $tenant->inscricaoMunicipal,
            'cnae_principal' => $tenant->cnaePrincipal,
            'data_abertura' => $tenant->dataAbertura,
            'responsavel_comercial' => $tenant->responsavelComercial,
            'responsavel_financeiro' => $tenant->responsavelFinanceiro,
            'responsavel_licitacoes' => $tenant->responsavelLicitacoes,
            'ramo_atuacao' => $tenant->ramoAtuacao,
            'principais_produtos_servicos' => $tenant->principaisProdutosServicos,
            'marcas_trabalhadas' => $tenant->marcasTrabalhadas,
