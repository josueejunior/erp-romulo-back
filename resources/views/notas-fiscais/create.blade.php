...
<div class="card p-8">
    <form method="POST" action="{{ route('notas-fiscais.store', $processo) }}" enctype="multipart/form-data">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div id="campos-logistica" class="md:col-span-2 grid grid-cols-1 md:grid-cols-2 gap-6 border-t pt-6 mt-6" style="display: none;">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        Transportadora
                    </label>
                    <input type="text" name="transportadora"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                           value="{{ old('transportadora') }}" placeholder="Nome da transportadora">
                </div>
                ...
                <div>
                    ...
                    <input type="text" name="numero_cte"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                           value="{{ old('numero_cte') }}" placeholder="Número do CTE">
                </div>
                ...
                <div>
                    ...
                    <select name="situacao_logistica"
                        ...
                        <option value="aguardando_envio" {{ old('situacao_logistica') == 'aguardando_envio' ? 'selected' : '' }}>Aguardando Envio</option>
                        <option value="em_transito" {{ old('situacao_logistica') == 'em_transito' ? 'selected' : '' }}>Em Trânsito</option>
                        <option value="entregue" {{ old('situacao_logistica') == 'entregue' ? 'selected' : '' }}>Entregue</option>
                        <option value="atrasada" {{ old('situacao_logistica') == 'atrasada' ? 'selected' : '' }}>Atrasada</option>
                    </select>
                </div>
            </div>

            <!-- Campos de Custos (para notas de entrada) -->
            <div id="campos-custos" class="md:col-span-2 grid grid-cols-1 md:grid-cols-3 gap-6 border-t pt-6 mt-6" style="display: none;">
                <div>
                    <label class="block text-sm font-semibold text-gray-700 mb-2">
                        Custo do Produto
                    </label>
                    <input type="number" name="custo_produto" step="0.01" min="0"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                           value="{{ old('custo_produto') }}" placeholder="0.00">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="custo_frete" step="0.01" min="0"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                           value="{{ old('custo_frete') }}" placeholder="0.00">
                </div>
                ...
                <div>
                    ...
                    <input type="number" name="custo_total" step="0.01" min="0"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                           value="{{ old('custo_total') }}" placeholder="0.00">
                </div>
                ...
                <div class="md:col-span-3">
                    ...
                    <input type="text" name="comprovante_pagamento"
                           class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                           value="{{ old('comprovante_pagamento') }}" placeholder="Número do comprovante">
                </div>
            </div>
