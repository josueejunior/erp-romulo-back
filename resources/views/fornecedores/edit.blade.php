...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        ...
        <p class="text-gray-600 mt-1">{{ $fornecedor->razao_social }}</p>
    </div>
</div>
...
<div class="card p-8">
    <form method="POST" action="{{ route('fornecedores.update', $fornecedor) }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <input type="text" name="razao_social" required 
                       ...
                       value="{{ old('razao_social', $fornecedor->razao_social) }}" placeholder="Digite a razão social">
                @error('razao_social')
            ...
            <div>
                ...
                <input type="text" name="nome_fantasia" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('nome_fantasia', $fornecedor->nome_fantasia) }}" placeholder="Nome fantasia (opcional)">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <input type="text" name="endereco" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('endereco', $fornecedor->endereco) }}" placeholder="Rua, número, complemento">
            </div>
            ...
            <div>
                ...
                <input type="text" name="cidade" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('cidade', $fornecedor->cidade) }}" placeholder="Nome da cidade">
            </div>
            ...
            <div>
                ...
                <input type="text" name="estado" maxlength="2"
                       ...
                       value="{{ old('estado', $fornecedor->estado) }}" placeholder="SP">
            </div>
            ...
            <div>
                ...
                <input type="text" name="cep" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('cep', $fornecedor->cep) }}" placeholder="00000-000">
            </div>
            ...
            <div>
                ...
                <input type="email" name="email" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('email', $fornecedor->email) }}" placeholder="email@exemplo.com">
            </div>
            ...
            <div>
                ...
                <input type="text" name="contato" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('contato', $fornecedor->contato) }}" placeholder="Nome do contato">
            </div>
            ...
            <div class="md:col-span-2">
                ...
                <textarea name="observacoes" rows="4" 
                          ...
                          placeholder="Observações adicionais...">{{ old('observacoes', $fornecedor->observacoes) }}</textarea>
            </div>
        </div>
        ...
        <div class="mt-8 flex gap-4 pt-6 border-t border-gray-200">
            ...
            <a href="{{ route('fornecedores.show', $fornecedor) }}" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-300 transition-colors font-semibold">
                Cancelar
            </a>
        </div>
    </form>
