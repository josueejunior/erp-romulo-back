...
<div class="mb-8 flex items-center gap-4">
    ...
    <div>
        ...
        <p class="text-gray-600 mt-1">Cadastre um novo fornecedor no sistema</p>
    </div>
</div>
...
<div class="card p-8">
    <form method="POST" action="{{ route('fornecedores.store') }}">
        ...
        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="md:col-span-2">
                ...
                <input type="text" name="razao_social" required 
                       ...
                       value="{{ old('razao_social') }}" placeholder="Digite a razão social">
                @error('razao_social')
            ...
            <div>
                ...
                <input type="text" name="nome_fantasia" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('nome_fantasia') }}" placeholder="Nome fantasia (opcional)">
            </div>
            ...
            <div>
                ...
                <input type="text" name="contato" 
                       class="w-full border border-gray-300 rounded-lg px-4 py-3 focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors" 
                       value="{{ old('contato') }}" placeholder="Nome do contato">
            </div>
        ...
        <div class="mt-8 flex gap-4 pt-6 border-t border-gray-200">
            ...
            <a href="{{ route('fornecedores.index') }}" class="bg-gray-200 text-gray-700 px-8 py-3 rounded-lg hover:bg-gray-300 transition-colors font-semibold">
                Cancelar
            </a>
        </div>
    </form>
