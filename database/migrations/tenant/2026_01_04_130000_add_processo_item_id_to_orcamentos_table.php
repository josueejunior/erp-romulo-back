...
return new class extends Migration
{
    ...
    public function up(): void
    {
        Schema::table('orcamentos', function (Blueprint $table) {
            ...
            // Adiciona transportadora_id se não existir
    ...
    public function down(): void
    {
        Schema::table('orcamentos', function (Blueprint $table) {
            $columns = [
                'processo_item_id', 'custo_produto', 'marca_modelo', 
                'ajustes_especificacao', 'frete', 'frete_incluido',
                'fornecedor_escolhido', 'observacoes', 'transportadora_id'
            ];
            
            foreach ($columns as $column) {
                if (Schema::hasColumn('orcamentos', $column)) {
                    if (in_array($column, ['processo_item_id', 'transportadora_id'])) {
